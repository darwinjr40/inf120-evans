  ...
  UNatural= class
    private   valor:integer;
      ...
      public
        ...
        function mult2():boolean;
        function mult3():boolean;
  end;
...
function UNatural.mult2(): boolean;
begin
 if((valor mod 2=0))then begin
  result:=true;
 end else begin
  result:=false;
 end;
...
function UNatural.mult3(): boolean;
begin
 if((valor mod 3=0))then begin
  result:=true;
 end else begin
  result:=false;
 end;
...
function UNatural.Primo(): boolean;
 var c,i:integer;
 begin
    c:=0;
    for i:=1 to valor do begin
