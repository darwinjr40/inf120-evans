...
//DESPUES DE CADA WRITE Y READ HACEN QUE EL PUNTERO AVANZA AL SIGUIENTE REGISTRO
Type
...
begin
   ...
   while(not eof(f))do begin //Cuando se avanza en un archivo registro por registro (EOF)
     read(f,r);              //leemos cada registro
